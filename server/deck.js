...
function playCard(shuffledDeck) {
    return shuffledDeck.pop();
}

//assumes players object has empty array hand, username, empty string high_rank, empty string hand_strength
function dealHands(shuffledDeck, ...players) {
    for (let player of players) {
        player.hand.push(playCard(shuffledDeck))
    }
}

function handChecker(hand, board) {
...
function multiHandChecker(board, players) {
    for (let player of players) {
        const hand_power = handChecker(player.hand, board)
...
function multiHandSorter(players) {
...
function userFolds(folded_user, sorted_names) {
